...
class Validator(threading.Thread):
    ...
    def run(self):
        while(self.is_running):
            incoming_data = "t1," + str(self.random_walk(self.initial_temp_1,self.noise_level_temperature))   + ",t2," + str(self.random_walk(self.initial_temp_2,self.noise_level_temperature)) + ",t3," + str(self.random_walk(self.initial_temp_3,self.noise_level_temperature)) + ",t4," + str(self.random_walk(self.initial_temp_4,self.noise_level_temperature))   
