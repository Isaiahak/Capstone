...
class UI:
    ...
    def __init__(self, root, temp1_graph_queue, temp2_graph_queue, temp3_graph_queue, temp4_graph_queue, 
                 volt1_graph_queue, volt2_graph_queue, volt3_graph_queue, volt4_graph_queue, 
                 pressure_graph_queue, notification_queue, configuration):
        ...
        self.volt_button_frame = tk.Frame(self.graph_button_frame, bg=self.colors["secondary"], width=1200, height=50)
        self.press_button_frame = tk.Frame(self.graph_button_frame, bg=self.colors["secondary"], width=1200, height=50)
        
        # Frame for each graph type
        self.temp_graph_frame = tk.Frame(self.graph_frame, bg=self.colors["light_bg"], width=1200, height=300)
        self.volt_graph_frame = tk.Frame(self.graph_frame, bg=self.colors["light_bg"], width=1200, height=300)
        self.pressure_graph_frame = tk.Frame(self.graph_frame, bg=self.colors["light_bg"], width=1200, height=300)
        
        self.temp_graph_frame2 = tk.Frame(self.graph_button_frame, bg=self.colors["light_bg"], width=1200, height=300)
        self.volt_graph_frame2 = tk.Frame(self.graph_button_frame, bg=self.colors["light_bg"], width=1200, height=300)
        self.pressure_graph_frame2 = tk.Frame(self.graph_button_frame, bg=self.colors["light_bg"], width=1200, height=300) 
        
        # Setup graph frames
        self.volt1_graph_frame = Graph_Frame("volt1", "voltage", self.volt_graph_frame, volt1_graph_queue,self.colors, self.fonts) 
        self.volt2_graph_frame = Graph_Frame("volt2", "voltage", self.volt_graph_frame, volt2_graph_queue,self.colors, self.fonts)
        self.volt3_graph_frame = Graph_Frame("volt3", "voltage", self.volt_graph_frame2, volt3_graph_queue,self.colors, self.fonts)
        self.volt4_graph_frame = Graph_Frame("volt4", "voltage", self.volt_graph_frame2, volt4_graph_queue,self.colors, self.fonts)
        ...
        self.press_graph_frame = Graph_Frame("pressure", "pressure", self.pressure_graph_frame, pressure_graph_queue,self.colors, self.fonts)    
        ...
        self.graph_map = {
            ...
            "volt1": self.volt1_graph_frame, 
            "volt2": self.volt2_graph_frame, 
            "volt3": self.volt3_graph_frame, 
            "volt4": self.volt4_graph_frame, 
            "pressure": self.press_graph_frame
        }                    
        ...
        self.graph_types_map = {
            ...
            "voltage": [self.volt1_graph_frame, self.volt2_graph_frame, self.volt3_graph_frame, self.volt4_graph_frame], 
            "pressure": [self.press_graph_frame]
        }
        ...
        self.graph_display = {
            self.pressure_graph_frame: len(self.pressure_graph_frame.winfo_children()), 
            self.volt_graph_frame: len(self.volt_graph_frame.winfo_children()), 
            self.temp_graph_frame: len(self.temp_graph_frame.winfo_children()),
            self.pressure_graph_frame2: len(self.pressure_graph_frame2.winfo_children()), 
            self.volt_graph_frame2: len(self.volt_graph_frame2.winfo_children()), 
